...
public class LoginSteps {
	...
	public void the_user_is_not_the_nonCommerce_login_page() { 
	...
	@When("the user entres valid credentials\\(username:{String},password:{string})")
	public void the_user_entres_valid_credentials(String email, String pwd) {
